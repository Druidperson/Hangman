...
while True:
    ...
    if player_option == "play":
        # Initial setup
        # Javascript is longer than 8 characters so it is expected that the game cannot be won if your word to guess is "javascript". Should probably remove it but cba.
